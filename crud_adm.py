...
# Dummy data paket
paket_cuci = [
    {"id_laundry": 1, "nama_paket": "paket 1", "durasi": 3, "harga": 5000, "unit": "2 kg"},
    {"id_laundry": 2, "nama_paket": "paket hemat", "durasi": 2, "harga": 6000, "unit": "5 kg"},
    {"id_laundry": 3, "nama_paket": "pahe a", "durasi": 5, "harga": 7000, "unit": "1 kg"},
    {"id_laundry": 4, "nama_paket": "murmer", "durasi": 4, "harga": 8000, "unit": "3 kg"},
    {"id_laundry": 5, "nama_paket": "murah", "durasi": 2, "harga": 9000, "unit": "4 kg"}
]
...
def lihat_paket_cuci(id_laundry):
    ...
    for paket in paket_cuci_laundry:
        print(f"Nama Paket: {paket['nama_paket']}")

    while True:
        pilihan_paket = input("--> Masukkan nama paket Laundry (0 untuk kembali): ")
        if pilihan_paket == "0":
            break
        else:
